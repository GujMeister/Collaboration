...
class WeatherPageVM {
    ...
    var fetchedData: WeatherForecast?
    var onDataFetched: ((WeatherForecast?) -> Void)?
    
    internal func fetchWeather(with passedCity: String) {
        WebService().fetchData(from: "https://api.openweathermap.org/data/2.5/forecast?q=\(passedCity)&appid=159e264bbb707514e8ea1734c14e4169",
                               resultType: WeatherForecast.self) { result in
            switch result {
